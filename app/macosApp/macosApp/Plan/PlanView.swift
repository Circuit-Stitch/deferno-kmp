...
struct PlanView: View {
    ...
    private func suggested(_ tasks: [Task]) -> Task? {
        ...
        tasks.first(where: { $0.priority == Priority.fire && !$0.workingState.isTerminal })
    ...
    /// "Start", and starting is what you do to a Task — a Habit is a commitment you keep, and clicking
