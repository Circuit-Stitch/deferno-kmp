 ...
 * truth [DefernoEnvironment.fromName], shared with the Android and iOS entry points — so macOS resolves
 * its injected env through the same seam rather than growing a third copy (#368 G22).
 */
