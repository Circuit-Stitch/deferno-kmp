...
/**
 * The per-scene navigation root (ADR-0013): the two-state Shell selected by auth state, re-entrant in
 * both directions, with system-back routed to the active Shell and the Main shell's add-to-plan intent
