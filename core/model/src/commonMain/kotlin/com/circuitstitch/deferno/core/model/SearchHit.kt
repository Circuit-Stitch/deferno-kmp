 ...
 * the done/active [isTerminal] de-emphasis, and the [completeBy]/[deadlineTimeOfDay] due for the trailing
 * date badge. [id] is the raw item UUID (a Task hit opens via `TaskId(id)`); it is not kind-typed because
 * the result set spans kinds.
 *
